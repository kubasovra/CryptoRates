        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstCurrencyCurrencyId = table.Column<int>(nullable: true),
                    SecondCurrencyCurrencyId = table.Column<int>(nullable: true),
                    ...
                    TargetPriceAbsoluteChange = table.Column<double>(nullable: false),
                    TargetPricePercentChange = table.Column<double>(nullable: false),
                    IsNotifyOnPrice = table.Column<bool>(nullable: false),
                    IsNotifyOnAbsoluteChange = table.Column<bool>(nullable: false),
                    IsNotifyOnPercentChange = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FirstCurrencyCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "CurrencyId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pairs_Currencies_SecondCurrencyCurrencyId",
                        column: x => x.SecondCurrencyCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "CurrencyId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pairs_FirstCurrencyCurrencyId",
                table: "Pairs",
                column: "FirstCurrencyCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Pairs_SecondCurrencyCurrencyId",
                table: "Pairs",
